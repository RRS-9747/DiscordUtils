package me.rrs.discordutils.bedwars.screamingbw;
...
public class ScreamingCore {
    ...
    private static void loadConfig(){
        try {
            config = YamlDocument.create(new File(DiscordUtils.getInstance().getModulesFolder(), "bedwars.yml"), DiscordUtils.getInstance().getResource("screamingbw.yml"),
    ...
    private static void registerEvent(){
        DiscordUtils.getInstance().getJda().addEventListener(new ScreamingStats());
    }
