...
public class EditPAPICommand implements CommandExecutor, TabCompleter {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        if (sender instanceof Player) {
            ...
            switch (field.toLowerCase()) {
                case "title":
                    if (DiscordStats.getDatabase().updatePAPITitle(newValue, searchValue)){
                ...
                case "papi":
                    ...
                    if (DiscordStats.getDatabase().updatePAPIString(newValue, searchValue)){
    ...
    public List<String> onTabComplete(@NotNull CommandSender sender, @NotNull Command command, @NotNull String alias, String[] args) {
        ...
        if (args.length == 1) {
            ...
            List<String> papiTitles = DiscordStats.getDatabase().getPAPITitles();
